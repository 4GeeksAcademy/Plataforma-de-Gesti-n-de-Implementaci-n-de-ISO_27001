    ...
    return (
        <div className="big-div">
            ...
            <div className="right-div">
                <h1 className="h3-custom text-center p-4" style={{borderBottomRightRadius: "15px", borderBottomLeftRadius: "15px"}}>Registro de Cuenta</h1>
                <div className="custom-card-password">
                    <form onSubmit={submitForm}>
                        <div className="mb-3 text-start">
                            <label htmlFor="full_name" className="form-label text-start">Nombre Completo</label>
